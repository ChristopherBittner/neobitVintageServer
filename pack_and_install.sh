...
echo "=== neobit Vintage Server Mod Packer ==="
echo "Mod: $MOD_NAME v$MOD_VERSION"
echo "Source: $MOD_DIR"v    
...
echo "   - modinfo.json"
echo "   - modicon.png"
echo "   - assets/neobitvintage/"
echo "   - patches for alchemy recall potion recipes"
